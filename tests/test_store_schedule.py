...
async def test_increment_review_count(store):
    ...
    task = Task(id="t1", type="test", title="T", instruction="I")
...
async def test_list_children(store):
    ...
    parent = Task(id="p1", type="t", title="Parent", instruction="I")
    child1 = Task(
        id="c1", type="t", title="Child1", instruction="I", parent_task_id="p1"
    )
    child2 = Task(
        id="c2", type="t", title="Child2", instruction="I", parent_task_id="p1"
    )
    other = Task(id="o1", type="t", title="Other", instruction="I")
...
async def test_list_children_empty(store):
    ...
    task = Task(id="lone", type="t", title="T", instruction="I")
    await store.create_task(task)
...
async def test_find_root_task_id(store):
    ...
    t1 = Task(id="r1", type="t", title="Root", instruction="I")
    t2 = Task(id="r2", type="t", title="Child", instruction="I", parent_task_id="r1")
    t3 = Task(
        id="r3", type="t", title="Grandchild", instruction="I", parent_task_id="r2"
    )
...
async def test_get_task_tree(store):
    ...
    t1 = Task(id="tr1", type="t", title="Root", instruction="I")
    t2 = Task(id="tr2", type="t", title="Child", instruction="I", parent_task_id="tr1")
    t3 = Task(
        id="tr3", type="t", title="Grandchild", instruction="I", parent_task_id="tr2"
    )
    unrelated = Task(id="tr4", type="t", title="Unrelated", instruction="I")
    await store.create_task(t1)
    await store.create_task(t2)
    await store.create_task(t3)
